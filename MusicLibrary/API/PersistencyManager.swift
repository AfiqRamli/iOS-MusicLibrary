...
// Class to hold and save albums model data

final class PersistencyManager {
    
    // Property to hold album data
    ...
    // This variable returns the URL of the cache directory, a good place to store files that u can redownload anytime
